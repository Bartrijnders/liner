...
export default function BalansClient({ projectId, project: initial, standbuilder }: Props) {
  ...
  // PM en AV zijn sell-only (geen aparte inkoopprijs bijgehouden)
      ...
      <div className="rounded-2xl bg-white border border-slate-200 overflow-hidden">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            ...
            <tbody>
              {/* Standbuilder — afgeleid uit calculatie */}
              ...
              {/* PM & Design — sell-only, bewerkbaar */}
              <tr className="border-t border-slate-100">
              ...
              {/* AV provision — sell-only, bewerkbaar */}
              <tr className="border-t border-slate-100">
